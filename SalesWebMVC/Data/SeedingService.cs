...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Bob Esponja", "esponja@gmail.com", new DateTime(2003, 10, 21), 1000.0, d2);
            Seller s3 = new Seller(3, "Wanderlei", "wander@gmail.com", new DateTime(1992, 4, 30), 1000.0, d3);
            Seller s4 = new Seller(4, "Rosildo", "rosi@gmail.com", new DateTime(1986, 8, 25), 1000.0, d4);
            Seller s5 = new Seller(5, "Chorumaca", "chorume@gmail.com", new DateTime(2002, 4, 21), 1000.0, d1);
            Seller s6 = new Seller(6, "Ziroca", "zoca@gmail.com", new DateTime(1998, 5, 9), 1000.0, d2);
